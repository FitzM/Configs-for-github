...
theme.menu_bg_normal                            = "#aaaaaa"
theme.menu_bg_focus                             = "#aaaaaa"
-- Focus Color Below
theme.bg_normal                                 = "#12414B"
--Main Color below
theme.bg_focus                                  = "#12414B"
theme.bg_urgent                                 = "#3ca4d8"
theme.fg_normal                                 = "#aaaaaa"
-- Active Screen Indicator below
theme.fg_focus                                  = "#297a7f"
...
function theme.at_screen_connect(s)
   ...
   s.quake = lain.util.quake({ app = "termite", height = 0.50, argname = "--name %s" })
    ...
    s.mybottomwibox = awful.wibar({ position = "bottom", screen = s, border_width = 0, height = dpi(14), bg = theme.bg_normal, fg = theme.fg_normal })
