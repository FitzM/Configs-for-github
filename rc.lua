...
globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "r", function () awful.util.spawn( "rofi -show drun" ) end,
        {description = search, group = "modkey"}),
    ...
    awful.key({ modkey }, "r", function () awful.util.spawn_with_shell( "org.kde.krunner") end,
        {description = "k-runner", group = "super"}),
    ...
    awful.key({ modkey1, altkey   }, "return", function() awful.util.spawn( "rofi -show drun" ) end,
        {description = rofi, group = "alt"}),
...
client.connect_signal("request::titlebars", function(c)
    ...
    awful.titlebar(c, {size = dpi(13)}) : setup {
        { -- Left
